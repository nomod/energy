class ResetsController < ApplicationController
  ...
  before_action :get_user_before_edit, only: [:edit]
  before_action :get_user_before_update, only: [:update]
  before_action :corrected_user, :time_expired, only: [:edit, :update]
